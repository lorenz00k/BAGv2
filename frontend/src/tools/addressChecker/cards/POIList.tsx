  ...
  krankenhaus: {
    ...
    icon: (
      ...
      >
        <path
          fillRule="evenodd"
          d="M10 2a1 1 0 011 1v4h4a1 1 0 110 2h-4v4a1 1 0 11-2 0V9H5a1 1 0 110-2h4V3a1 1 0 011-1z"
          clipRule="evenodd"
        />
      </svg>
    ),
  ...
  friedhof: {
    ...
    icon: (
      ...
      >
        <path
          fillRule="evenodd"
          d="M6 2a2 2 0 00-2 2v1H3a1 1 0 000 2h1v10a1 1 0 001 1h10a1 1 0 001-1V7h1a1 1 0 100-2h-1V4a2 2 0 00-2-2H6zm0 2h8v1H6V4zm0 3h8v9H6V7z"
          clipRule="evenodd"
        />
      </svg>
    ),
